        ...
        <modal
            ...
            <div class="modal-footer">
                <a
                    ...
                    <span class="btn__title">{{ $t('modal.translateCta') }}</span>
                </a>
            </div>
        </modal>
    </div>
...
export default {
    ...
    methods: {
        async translate(event) {
            const trans_button = event.currentTarget;
            if (trans_button) {
                trans_button.classList.remove('font-icon-translatable');
                trans_button.classList.add('btn--loading', 'loading');

                let title = trans_button.querySelector('.btn__title');
                if (title) title.style.visibility = 'hidden';

                if (!trans_button.querySelector('.btn__loading-icon')) {
                    trans_button.insertAdjacentHTML(
                        'beforeend',
